            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="tables-editable">Editable Tables</a></li>
                    </ul>
                </li>
    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="/items" class="waves-effect">
                        <i class="ti-package"></i>
                        <span>Items</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="/units" class="waves-effect">
                ...
                <li>
                    <a href="/item-units" class="waves-effect">
                        <i class="ti-exchange-vertical"></i>
                        <span>Item Unit Conversion</span>
                    </a>
                </li>

                <li>
                    <a href="/stocks" class="waves-effect">
                        <i class="ti-archive"></i>
                        <span>Stock</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="/stock-movements" class="waves-effect">
                        <i class="ti-reload"></i>
                ...
                <li>
                    <a href="/journal-entries" class="waves-effect">
                        <i class="ti-book"></i>
                ...
                <li>
                    <a href="/journal-report" class="waves-effect">
                ...
                <li>
                    <a href="/incomes" class="waves-effect">
                ...
                <li>
                    <a href="/expenses" class="waves-effect">
                ...
                <li>
                    <a href="/income-categories" class="waves-effect">
                        <i class="ti-tag"></i>
                ...
                <li>
                    <a href="/expense-categories" class="waves-effect">
                        <i class="ti-tag"></i>
